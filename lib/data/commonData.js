...
export const vibrantColors = ["#2779f0", "#2794f0", "#855aff", "#bf41ff"];
...
export const company_types = [
  ...
  { label: "OPC", value: "OPC" },
  {
    ...
    value: "Farmer Producer Organisation (FPO)",
  },
...
export const bank_accountTypes = [
  { label: "Saving ", value: "Saving " },
  { label: "Current", value: "Current" },
];

// service panel for manufacturer
export const service_manufacturer_dispositions = [
...
export const service_manufacturer_subDispositions = {
  non_contactable: [
  ...
  deal: [{ label: "Deal done", value: "deal_done" }],
  followup: [{ label: "Followup", value: "followup" }],
  prospect: [
    { label: "Prospect NI", value: "prospect_ni" },
    { label: "Prospect intersested", value: "prospect_interested" },
  ],
};

export const serviceDispositionColors = {
  non_contactable: "#d95012",
  not_interested: "#12d9b7",
  deal: "#0ba12d",
  followup: "#0b70be",
  prospect: "#5c1dd7",
};
